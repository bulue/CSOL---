                ...
                case State.Counter_Strike:
                    {
                        ...
                        do
                        {
                            ...
                            int lingqujiangli_time = System.Environment.TickCount;
                            int lingguojiangli_time = System.Environment.TickCount;
                            ...
                            do
                            {
                                ...
                                if (x > 0 && y > 0 && w > 0 && h > 0)
                                {
                                    ...
                                    if (bInputPwd
                                        && CheckInterLastTime(ref lingqujiangli_time, 1000)
                                        && CommonApi.FindPic(sX + 470, sY + 670, 78, 34, @".\BMP\领取奖励.bmp", 0.999, out dx, out dy))
                                    {
                                        CommonApi.Left_Click(dx + 5, dy + 5);
                                        Sleep(200);
                                    ...
                                    if (bInputPwd
                                        && CommonApi.FindPic(sX + 489, sY + 500, 37, 27, @".\BMP\毫礼确认.bmp", 0.97, out dx, out dy))
                                    {
                                        queren_Lasttime = System.Environment.TickCount;
